...
//	m_last_score_div : null,
	...
	createLabelTitleTextSprite : function(x,y,w,h, text, color) {
		...
		this.m_title_div.style.right = 0;
		this.m_title_div.style.bottom = 0;
		this.m_title_div.style.margin = "auto";
...
//		var img = null;
		...
		if(!this.m_load_ui) {
			...
			this.createLabelTitleTextSprite(0,-60,253,40, FZ.GameText.TEXT_GAME_OVER, "#FEE7B4");
	...
	//		this.createStrScoreDiv();
        ...
        document.getElementById("mainDiv").childNodes[4].style.display = "none";
