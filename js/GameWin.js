...
//	BTN_MENU_AWARDS_INDEX : 0,
	...
	CUR_BTN_DEFS : [ ["BTN_MAIN_MENU", "BTN_MAIN_MENU"]],
...
//		spr.m_div.style.textIndent = -10+ "px";
	...
	preProcess : function(preState, curState, totalScore, totalUsedTime, totalUsedHint,reward) {
		var index = 0;
//		var img = null;
		var btn = null;
		var info = null;
		...
		var mySelf = this;
		if(!this.m_load_ui) {
			this.createUIs(this.CUR_UI_DEFS,reward);
			...
			this.m_main_div.style.display = "block";
            var node = document.getElementById("you_win");
            if(reward){
                node.style.backgroundImage = "url(imgs/YOU_WIN_BG.png)";
            }else{
                node.style.backgroundImage = "url(imgs/WIN_BG.png)";
            }
		}
	...
	createStrLeftTimeDiv : function() {
        console.log("createStrLeftTimeDiv");
