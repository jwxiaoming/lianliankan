...
//		this.fade_in();
		this.m_timer = setTimeout(FZ.Tools.bind(this, this.fade_in), 0);
...
//		this.m_timer = setTimeout(FZ.Tools.bind(this, this.AIUpdate), 1000);
    ...
    fade_in : function() {
    	...
    	this.m_timer = setTimeout(FZ.Tools.bind(this, this.fade_out), 0);
    },
    
    fade_out : function() {
    	this.m_main_div.style.webkitTransitionDuration = "1s";
    	this.m_main_div.style.opacity = 0;
    	this.m_timer = setTimeout(FZ.Tools.bind(this, this.fade_end), 0);
    },
