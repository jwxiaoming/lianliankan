FZ.Diamond = FZ.newClass({
    ...
    init: function(line, col, style, state){
        ...
        this.m_y = 100 + this.m_line * FZ.GameDefs.GRID_HEIGHT + FZ.GameDefs.DREAMPET_OFFSET_X;
        ...
        this.m_div_focus.style.backgroundSize = "cover";

        this.m_div_focus.style.backgroundColor = "#ffffff";
        this.m_div_focus.style.backgroundImage = "url(imgs/farm/" + num + ".png)";
        this.hidden();
...
//        this.m_div_hint.style.zIndex = 3;
    ...
    setCss: function(){
        this.m_div = document.createElement("div");
        this.m_div.style.width = FZ.GameDefs.GRID_WIDTH + "px";
        this.m_div.style.height = FZ.GameDefs.GRID_HEIGHT + "px";
        ...
        this.m_div.style.backgroundSize = "cover";
        this.m_div.style.borderRadius="1px";
        if (this.flag) {
            this.m_div.style.backgroundColor = "#57b8ee";
        } else {
            this.m_div.style.backgroundColor = "#257ec4";
        }
    ...
    updatePos: function(){
        ...
        if(Math.abs(this.m_col-this.m_line) % 2 == 0){
            this.m_div.style.backgroundColor = "rgb(87, 184, 238)";
        }else{
            this.m_div.style.backgroundColor = "rgb(37, 126, 196)";
        }
        this.m_div.style.left = (this.m_x) + "px";
        this.m_div.style.top = (this.m_y - 5) + "px";
