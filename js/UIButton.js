(function(){
    FZ.UIButton = FZ.newClass({
        ...
        setPos: function(info){
            if(info.center){
                this.m_div.style.left = 0;
                this.m_div.style.top = 0;
                this.m_div.style.right = 0;
                this.m_div.style.bottom = 0;
                this.m_div.style.margin ="auto";
            }
            if(info.margin){
                this.m_div.style.left = 0;
                this.m_div.style.right = 0;
                this.m_div.style.margin = info.margin;
            }
            if(info.x){
                this.m_div.style.left = info.x + "px";
            }
            if(info.y){
                this.m_div.style.top = info.y + "px";
            }
            if(info.r){
                this.m_div.style.right = info.r + "px";
            }
            if(info.b){
                this.m_div.style.bottom = info.b + "px";
            }
        },
